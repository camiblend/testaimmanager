...
left join ejecuciones using (to_join,checklist_type_id,venue_id) ;;
  ...
  dimension: dashboard_2 {
    ...
    link: {
      ...
      url: "https://aimmanagertest.cloud.looker.com/dashboards/8?tipo_checklist={{ openplaza_check_cat_4_adherencia.tipo_checklist}}&Recinto={{ openplaza_check_cat_4_adherencia.venue_name}}"
